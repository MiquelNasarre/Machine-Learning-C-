...
MNIST       MNIST::helper;
uint8_t*    MNIST::trainingSetLabels    = nullptr;
uint8_t*    MNIST::testingSetLabels     = nullptr;
uint8_t**   MNIST::trainingSetImages    = nullptr;
uint8_t**   MNIST::testingSetImages     = nullptr;
size_t      MNIST::n_training_images    = 0;
size_t      MNIST::n_testing_images     = 0;
